...
from deeplearning_models.stacked_autoencoder import StackedAutoencoder
...
def prepare_mashup(data):
    ...
    with open('./datasets/'+'API_mashup.txt','r') as f:
        mashup_file = open("./datasets/"+'final_Mashup3.txt','w')
...
train_neural_network(network_architecture, epochs=2, batch_size=50, learning_rate=1e-3, activation_fct=tf.nn.sigmoid)
